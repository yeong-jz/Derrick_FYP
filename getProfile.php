...
<body>
  <?php
    $query="SELECT * FROM accounts_info WHERE Username='".$_GET['username']."'";
    $result=mysqli_query($con,$query);
    $row=mysqli_fetch_array($result);
  ?>

  <div class="col-sm--offset-4">
     <img  style="height: 200px; margin-bottom:10px;" src="/fyp2/accounts_photo/<?php echo $row['Image']; ?>" alt="" class="img-responsive img-circle">
  </div>
  <div class="col-sm-8 col-xs-offset-1" style="border: 2px solid black; padding: 5px; width: 83%;"  >
      <div class="row">
          <div class="col-sm-3 col-xs-3">
              <label>Name:</label>
          </div>
          <div class="col-sm-9 col-xs-9 ">
              <p id="display"><?php echo $row['Fullname']; ?></p>
          </div>
      </div>
      <div class="row">
          <div class="col-sm-3 col-xs-3">
...
<div class="col-xs-12">
    <h4 style="text-align: left">Biography</h4>
    <div class="col-xs-12">
        <p id='bio' style="border: 2px solid black; padding: 5px;"><?php echo $row['bio']; ?></p>
    </div>
    <p id='reviewsystem'></p>
</div>
...
<div class='col-xs-12'>
  <h4 style="text-align: left">Review</h4>
 <div class='col-sm-3'>
  <div class='row'>
